...
<div class="wrap">
	...
	<div class="dataTable_wrapper">
		<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
			...
			<?php pro_get_table_actions(array('pro_bulk_delete_albums' => 'Delete', 
											'pro_bulk_disable_albums' => 'Disable', 
											'pro_bulk_enable_albums' => 'Enable')); ?>
		</div>
		...
		<?php else: ?>
		<?php require_once PRO_PLUGIN_DIR . '/html/albums_rows.php'; ?>
		<?php endif; ?>
		</tbody>
		</table>
	...
	if( isset($_REQUEST['view']) && isset($_REQUEST['album_id']))
	{
		...
		$album = $gpro->pro_get_album($album_id);
		//print_r($album);
		$images = $gpro->pro_get_album_images($album_id);
		//print_r($images); 
		...
		if (!(strstr($_REQUEST['view'], '/')) && !(strstr($_REQUEST['view'], "\\"))) {
			require_once PRO_PLUGIN_DIR . '/html/' . $_REQUEST['view'] . '.php';
		}
	} 
	?>
</div>