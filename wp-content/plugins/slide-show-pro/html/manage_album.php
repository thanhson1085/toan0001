...
?>
<?php if(isset($gpro->messages['upload']) && is_array($gpro->messages['upload']) && count($gpro->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gpro->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var pro_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php pro_get_table_actions(array('pro_bulk_delete_images' => 'Delete', 
											'pro_bulk_disable_images' => 'Disable', 
											'pro_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once PRO_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="pro_single_image_upload" />
...
-->
	...
	var pro_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",pro_get_album_dir($album['album_id'])); ?>";
	var pro_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}pro_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
