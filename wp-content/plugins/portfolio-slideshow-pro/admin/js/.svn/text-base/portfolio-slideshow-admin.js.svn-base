...
$(function() {
	...
	$('#portfolio_slideshow_options_pagerstyle').parent().parent().nextAll('tr:lt('+3+')').addClass('thumbs');
...
$('select#portfolio_slideshow_options_pagerstyle').change(function() {
	...
	$('#togglethumbs, #togglestate').parent().parent().addClass('toggle');
	$('#togglestate').parent().parent().addClass('togglestate hidden');
	
	pagerStyleVal = $('select#portfolio_slideshow_options_pagerstyle').val();
	if ( pagerStyleVal != "thumbs" && pagerStyleVal != "carousel"  ) { $('.toggle').addClass("hidden"); }
		
	$('select#portfolio_slideshow_options_pagerstyle').change(function() {
		pagerStyleVal = $('select#portfolio_slideshow_options_pagerstyle').val();
		if ( pagerStyleVal != "thumbs" && pagerStyleVal != "carousel" ) { $('.toggle').addClass("hidden"); } else { $('.toggle').removeClass("hidden"); }
	});
	
	if ( $('#togglethumbs:checked').val() !== undefined ) {
	 $(".togglestate").removeClass('hidden');
	}
	
	$('#togglethumbs').click(function() {
	    $(".togglestate").toggle(this.checked);
	});
